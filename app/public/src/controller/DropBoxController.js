class DropBoxController {
    ...
    initEvents(){
        ...
        this.btnRename.addEventListener('click', event => {
            ...
            let file = JSON.parse(li.dataset.file);
            let name = prompt("Renomer o arquivo: ", file.name);
    ...
    uploadProgress(event, file, amountFiles){
        ...
        if(amountFiles > 1){
            ...
            this.fileNameEl.innerHTML = "Enviando " +amountFiles+ " arquivos";
        
        } else {
            
            this.fileNameEl.innerHTML = "Enviando o arquivo " + file.name;
    ...
    renderNav(){
        ...
        for(let i = 0; i < this.currentFolder.length; i++) {
            ...
            if((i + 1) === this.currentFolder.length){
                ...
                span.innerHTML = this.getSpanFolder(folderName, path);
